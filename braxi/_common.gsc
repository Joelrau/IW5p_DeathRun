...
isGhost( player )
{
	return isDefined(player) && isDefined(player.ghost) && player.ghost == true;
}
...
partymode() 
{
	...
	while(1)
	{
		setExpFog(1, 900, RandomFloat(1), RandomFloat(1), RandomFloat(1), 1, 0.1); 
		setSunLight(RandomFloat(2), RandomFloat(2), RandomFloat(2)); 
		wait 0.5;
	}
}
